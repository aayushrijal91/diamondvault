		...
		<div class="row justify-content-center justify-content-lg-between align-items-center gy-4">
			...
			<div class="col-auto">
				<div class="row justify-content-center justify-content-lg-end align-items-center gx-xxl-5">
					<div class="col-auto">
						<a href="<?= $facebook ?>" class=""><?= renderImg('facebook.png', 'icons') ?></a>
					</div>
					<div class="col-auto">
					...
					<div class="col-auto">
						<a href="mailto:<?= $admin_email ?>" class=""><?= renderImg('email.png', 'icons') ?></a>
					</div>
					<div class="col-auto">
						<a href="<?= $whatsapp ?>" class=""><?= renderImg('whatsapp.png', 'icons') ?></a>
					</div>
				</div>
			</div>
